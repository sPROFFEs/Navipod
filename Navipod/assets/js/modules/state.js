...
export function setSearchDebounce(val) {
  searchDebounce = val;
}
...
export function setUserPlaylists(val) {
  userPlaylists = val;
}
export function setRecentPlaylists(val) {
  recentPlaylists = val;
}
...
export function setContextQueue(val) {
  contextQueue = val;
}
export function setContextIndex(val) {
  contextIndex = val;
}
export function setCurrentViewList(val) {
  currentViewList = val;
}
export function setIsQueueOpen(val) {
  isQueueOpen = val;
}
export function setShuffleMode(val) {
  shuffleMode = val;
}
export function setRepeatMode(val) {
  repeatMode = val;
}
export function setOriginalContextQueue(val) {
  originalContextQueue = val;
}
export function setCurrentViewName(val) {
  currentViewName = val;
}
export function setCurrentViewParam(val) {
  currentViewParam = val;
}
export function setIsSidebarOpen(val) {
  isSidebarOpen = val;
}
export function setIsFullscreenPlayerOpen(val) {
  isFullscreenPlayerOpen = val;
}
export function setLastPrevClickTime(val) {
  lastPrevClickTime = val;
}
export function setYtPlayer(val) {
  ytPlayer = val;
}
export function setYtReady(val) {
  ytReady = val;
}
export function setLastSyncVersion(val) {
  lastSyncVersion = val;
}
export function setHeartbeatInterval(val) {
...
export function setIsSeeking(val) {
  isSeeking = val;
}
